...
Result: exit 0
Duration: 48s
Ran at: 2026-09-24T14:08:27.825Z
...
✓ Generating static pages using 15 workers (39/39) in 145ms
...
RADULF_SPLIT_CHECK=1 node_modules/.bin/vitest run src/server/splitProcesses.test.ts
 ...
 RUN  v4.1.11 /var/lib/radulf/worktrees/run-background-work-under-leases-add-the-HA-bXlB-fLrHvMLBqCLIz

make[1]: Entering directory '/var/lib/radulf/worktrees/run-background-work-under-leases-add-the-HA-bXlB-fLrHvMLBqCLIz'
...
make[1]: Leaving directory '/var/lib/radulf/worktrees/run-background-work-under-leases-add-the-HA-bXlB-fLrHvMLBqCLIz'
 ✓ src/server/splitProcesses.test.ts (9 tests) 22020ms
     ...
     ✓ drives a card from Todo to In Review through the web-only process  2346ms
     ✓ cancelling a looping card from the web-only process ends the run in the worker  502ms
     ✓ pausing a looping card from the web-only process pauses it at the iteration boundary and resume starts a new claimed run  1020ms
     ✓ two workers never run two runs of one repo at once with a cap of one  792ms
     ✓ two approvals from two web processes deliver serially and a loop overlapping a sibling merge reports no tampering  698ms
     ✓ SIGKILL on a worker mid-loop hands the card to the other worker within the stale window  15396ms

 Test Files  1 passed (1)
      Tests  9 passed (9)
   Start at  14:08:53
   Duration  22.14s (transform 35ms, setup 0ms, import 52ms, tests 22.02s, environment 0ms)
